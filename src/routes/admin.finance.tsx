...
export const Route = createFileRoute("/admin/finance")({
  head: () => ({ meta: [{ title: "finance · Admin Helix" }] }),
  component: Page,
});
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <h1 className="mt-1 text-2xl font-semibold capitalize">finance</h1>
      ...
      <div className="rounded-xl border border-white/10 bg-white/[0.02] p-8 text-center text-sm text-white/50">
        Conteúdo do módulo <b className="text-white/80">finance</b> será implementado nas próximas etapas.
      </div>
    </div>
  );
}
