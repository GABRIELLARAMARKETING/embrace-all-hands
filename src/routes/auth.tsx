      ...
      >
        ...
        >
          <div
            ...
            style={{ background: "linear-gradient(90deg, transparent, #c084fc, #8b5cf6, transparent)" }}
          />
          ...
          <form onSubmit={onSubmit} className="mt-7 space-y-5" noValidate>
            ...
            <div className="rounded-2xl border border-violet-400/20 bg-violet-950/40 p-4 text-xs leading-relaxed text-violet-100/70">
              Ao criar conta você concorda com os{" "}
              <a href="#" className="font-bold text-violet-400 hover:text-violet-300">
                Termos de Uso
              </a>{" "}
            ...
            <motion.button
              ...
              style={{
                background: "linear-gradient(180deg, #a855f7 0%, #8b5cf6 55%, #6d28d9 100%)",
                boxShadow:
          ...
          <p className="text-center text-sm text-violet-100/70">
            Já tem conta?{" "}
            <Link to="/login" className="font-extrabold text-violet-400 hover:text-violet-300">
              Fazer login
            </Link>
          </p>
