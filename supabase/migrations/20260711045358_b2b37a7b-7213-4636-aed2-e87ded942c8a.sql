...
BEGIN
  ...
  IF is_gameover THEN
    ...
    INSERT INTO public.wallet_transactions(
      ...
      new_bal,
      CASE
        WHEN actual_delta = 0 THEN 'Game over Helix - saldo já estava zerado'
        ELSE 'Perda Helix - saldo zerado (R$ ' || to_char(-actual_delta, 'FM999999990.00') || ')'
      END
    );
  ELSE
    reward_c := CASE
